...
## [unreleased] — Stage 9-beta & community extensions merge
...
### Test suite
- **114/114 PASS** (was 100/100 in v0.5.0-alpha). The 14 new tests are
  differential: they run through both the Stage-0 interpreter and the
  native compiler and require identical output. Bootstrap is still
  deterministic.
